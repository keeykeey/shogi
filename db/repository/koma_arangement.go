...
func ExportKomaArrangement() []KomaArrangement {
	...
	komaArrangements := []KomaArrangement{
		...
		KomaArrangement{ID:19 ,ArrangementID: arrangements[0].ID, KomaID: komas[6].ID, PositionID: positions[64].ID, IsFirstMove: true, IsFront: true },
		KomaArrangement{ID:20 ,ArrangementID: arrangements[0].ID, KomaID: komas[7].ID, PositionID: positions[70].ID, IsFirstMove: true, IsFront: true },
		...
		KomaArrangement{ID:39 ,ArrangementID: arrangements[0].ID, KomaID: komas[6].ID, PositionID: positions[16].ID, IsFirstMove: false, IsFront: true },
		KomaArrangement{ID:40 ,ArrangementID: arrangements[0].ID, KomaID: komas[7].ID, PositionID: positions[10].ID, IsFirstMove: false, IsFront: true },
